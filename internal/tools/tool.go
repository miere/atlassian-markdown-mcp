// Package tools defines the Tool abstraction that every atlassian-markdown-mcp
// capability implements, together with a small in-memory registry shared by
// the frontends.
package tools
...
// atlassian-markdown-mcp must satisfy. Frontends (CLI, MCP, ...) consume tools
