// Package ping implements the atlassian-markdown-mcp health-check tool. It
// returns the fixed string "pong" with no error, and serves as the canonical
// example of the tool contract under internal/tools.
package ping
