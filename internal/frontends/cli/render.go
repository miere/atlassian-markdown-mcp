...
// Render converts a tool result into the text the CLI writes to stdout.
// The contract per tool is documented at the tool package; this is the
// dispatch site that picks the appropriate representation.
