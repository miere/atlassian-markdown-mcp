...
// resolve picks the registered tool name out of args and returns the remaining
// tokens to pass to flag parsing. Flat lookup is tried first; if it misses
// and a second token is present, a dotted "<a>.<b>" lookup is tried.
